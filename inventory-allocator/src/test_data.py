...
"""
model_warehouses = [
    {"name": "owd", "inventory": {"apple": 1, "banana": 4, "oranges": 10}},
    {"name": "dm", "inventory": {"apple": 7, "banana": 2, "oranges": 0}},
    {"name": "empty", "inventory": {}},
    {"name": "exotic", "inventory": {"apple": 1, "avocado": 4, "banana": 6}},
]
...
warehouse_fulfillment_one = [{"owd": {"apple": 1, "banana": 2}}]
...
"""
order_four = {"apple": 7}
warehouse_fulfillment_four = [{"dm": {"apple": 7}}]
...
warehouse_fulfillment_five = [{"dm": {"apple": 4}}, {"exotic": {"avocado": 4}}]
